...
const theOldWayOfWriteFun = function(course) {
  return `I am currently enrolled in ${course}`;
};

// TODO: Uncomment the following line of code to see the output in the browser console
 console.log('The old way Of write the fun :', theOldWayOfWriteFun('Code 301--Date 2021-8-28'));
...
const theNewWay = (CorseNameIS) => {
  return `I am currently enrolled in ${CorseNameIS}`;
};
...
const withoutParens = courseOneParameter => {
  return `I am currently enrolled in ${courseOneParameter}`;
};
...
// TODO: Uncomment the following line of code to see the output in the browser console
 console.log('Let\'s do some math:', add(5, 10));
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Add as a one-liner:', addOneLiner(4, 0));
...
// TODO: Uncomment the following line of code to see the output in the browser console
 console.log('Multi-line arrow function:', multiLiner('hi shahd'));
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('Hello from the old object function', oldObject(['hi', 'shahd', 'are you there?']));
